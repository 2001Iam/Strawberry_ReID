...
class ft_net(nn.Module):
    ...
    def __init__(self, class_num=673, droprate=0.5, stride=2, circle=False, ibn=False, linear_num=512):
...
# Define the ft_net18 Model
class ft_net18(nn.Module):

    def __init__(self, class_num=673, droprate=0.5, stride=2, circle=False, linear_num=512):
...
# Define the ft_net34 Model
class ft_net34(nn.Module):

    def __init__(self, class_num=673, droprate=0.5, stride=2, circle=False, linear_num=512):
        super(ft_net34, self).__init__()
        model_ft = models.resnet34(pretrained=True)
        # avg pooling to global pooling
        if stride == 1:
            model_ft.layer4[0].downsample[0].stride = (1, 1)
