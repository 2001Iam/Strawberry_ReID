...
def make_dataset(
    ...
    for target_class in sorted(class_to_idx.keys()):
        ...
        for root, _, fnames in sorted(os.walk(target_dir, followlinks=True)):
            for fname in sorted(fnames, key=get_number):
...
class BerryDatasets(ImageFolder):
    def __init__(self,data_path,data_transforms):
        super().__init__(data_path, data_transforms)
    @staticmethod
    def make_dataset(
        directory: Union[str, Path],
